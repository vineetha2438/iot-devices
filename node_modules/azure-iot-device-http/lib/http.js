...
var http_receiver_js_1 = require("./http_receiver.js");
...
var Http = (function (_super) {
    ...
    function Http(config) {
        ...
        _this._http = new azure_iot_http_base_1.Http();
        return _this;
    }
    /**
     ...
     */
    Http.prototype.getReceiver = function (done) {
        if (!this._receiver) {
            this._receiver = new http_receiver_js_1.HttpReceiver(this._config, this._http);
        }
